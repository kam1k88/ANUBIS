...
На данный момент проект представляет собой веб-приложение для парсинга данных с сайта МосГорСуд. Приложение предоставляет REST API для запуска парсера и автоматизированного сбора информации о судебных делах.
